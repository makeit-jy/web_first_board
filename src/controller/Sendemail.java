...
public class Sendemail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Sendemail 의 doGet 호출");
	}
...
request.setCharacterEncoding("UTF-8");
		...
		String user = "oceanbelow@naver.com"; // 자신의 네이버 계정
		String password = "!dhzlgozld817";// 자신의 네이버 패스워드

		// 메일 받을 주소
		/* String to_email = m.getEmail(); */
//		String to_email = "oceanbelow@naver.com";
		...
		request.setAttribute("number", AuthenticationKey);
		RequestDispatcher rd = request.getRequestDispatcher("/join.jsp");
		rd.forward(request, response);
		
		
		System.out.println("이메일을 보냈다");
	}
